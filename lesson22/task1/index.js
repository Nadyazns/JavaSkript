...
const attachHandlersOff = turnOff;
...
attachHandlers.addEventListener('click', attachHandlersOn);
removeHandlers.addEventListener('click', attachHandlersOff);